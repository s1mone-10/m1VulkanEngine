...
It is mainly based on the tutorial at [vulkan-tutorial.com](https://vulkan-tutorial.com/), but I tried to create a structure engine to facilitate future developments.
...
This project is still under development. My next steps could be are:

*   Improve lighting and add shadows.
*   Imporve rendering of multiple objects and using instancingg for identical objects.
*   Multithreading.
